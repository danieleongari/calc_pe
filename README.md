...
* `Q(MJ/kg)`: heat requirement per kg of CO<sub>2</sub>
* `Wcomp(MJ/kg)`: compression work per kg of CO<sub>2</sub>
* `WCv(kg/m3)`: volumetric working capacity, i.e., mass of CO<sub>2</sub>
produced per m<sup>3</sup> of bed, considering the void fraction (`-vf`).
* `WCg(kg/kg)`: gravimetric working capacity, i.e., mass of CO<sub>2</sub>
produced per kg of bed, considering the void fraction (`-vf`).
